            ...
            <ul>
                ...
                <li><span>Time Line</span>
                    <ul>
                        ...
                        <li><a href="timeline-videos.jsp" title="">timeline videos</a></li>
                ...
                <li><span>Account Setting</span>
                    <ul>
                        ...
                        <li><a href="edit-profile-basic.jsp" title="">edit profile basics</a></li>
                        ...
                        <div class="timeline-info">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a class="active" href="timeline-friends.jsp" title="" data-ripple="">Friends</a>
                                ...
                                <aside class="sidebar static">
                                    <div class="widget">
                                        ...
                                        <ul class="naves">
                                            ...
                                            <li>
                                                <i class="ti-image"></i>
                                                <a href="timeline-photos.jsp" title="">images</a>
                                            </li>
                                            <li>
                                                <i class="ti-video-camera"></i>
                                                <a href="timeline-videos.jsp" title="">videos</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="widget stick-widget">
                                        ...
                                        <ul class="short-profile">
                                            <li>
                                                <span>about</span>
                                                <p>Hi, i am jhon kates, i am 32 years old and worked as a web developer
                                                    in microsoft company. </p>
                                            </li>
                                            <li>
                                    ...
                                    <div class="frnds">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item"><a class="${navFriendsReq}" href="#frends-req"
                                                ...
                                                Requests</a></li>
                                            <li class="nav-item"><a class="${navReqsSent}" href="#frends-reqs-sent"
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane ${tabFriends}" id="frends">
                                                <ul class="nearby-contct">
                                                    <c:forEach var="friend" items="${friends}">
                                                        <li>
                                                            <div class="nearly-pepls">
                                                                <figure>
                                                                    <img src="images/resources/friend-avatar9.jpg"
                                                                         alt="">
                                                                </figure>
                                                                <div class="pepl-info">
                                                                    <h4><a href="/time-line?userId=${friend.userId}"
                                                                           title="">${friend.firstName} ${friend.lastName}</a>
                                                                    </h4>
                                                                    <a href="/friends?action=deleteFriend&userId=${friend.userId}" title="" class="add-butn more-action"
                                            ...
                                            <div class="tab-pane ${tabFriendsReq}" id="frends-req">
                                                <ul class="nearby-contct">
                                                    <c:forEach var="request" items="${friendRequests}">
                                                        <li>
                                                            <div class="nearly-pepls">
                                                                ...
                                                                <div class="pepl-info">
                                                                    <h4><a href="${request.userId}" title="">${request.firstName} ${request.lastName}</a>
                                                                    </h4>
                                                                    <a href="/friends?action=deleteRequest&userId=${request.userId}" title="" class="add-butn more-action"
                                                                       data-ripple="">delete Request</a>
                                                                    <a href="/friends?action=confirmRequest&userId=${request.userId}" title="" class="add-butn"
                                            ...
                                            <div class="tab-pane ${tabReqsSent}" id="frends-reqs-sent">
                                                <ul class="nearby-contct">
                                            ...
                                            <%--											developing search friends--%>
                                            <div class="tab-pane ${tabFriendsSearch}" id="frends-search">
                                                <ul class="nearby-contct">
                                                    <li>
                                                        <div class="mh-head second">
                                                            <form class="mh-form" action="/searchFriend" method="get">
                                                                <input placeholder="search" name="name"/>
                                                                <%--																<a href="/searchFriend" class="fa fa-search"></a>--%>
                                                                <button type="submit" class="fa fa-search">Search
                                                                </button>
                                                            </form>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <c:forEach var="result" items="${results}">
                                                        <li>
                                                            <div class="nearly-pepls">
                                                                ...
                                                                <div class="pepl-info">
                                                                    <h4><a href="/time-line?userId=${result.userId}"
                                                                           title="">${result.firstName} ${result.lastName}</a>
                                                                    </h4>
                                                                    <c:choose>
                                                                        <c:when test="${result.extraField1 == 'Active'}">
                                                                            <a href="/friends?action=deleteFriend&userId=${result.userId}" title="" class="add-butn more-action"
                                                                               data-ripple="">unfriend</a>
                                                                        </c:when>
                                                                        <c:when test="${result.extraField1 == 'GetRequest'}">
                                                                            <a href="/friends?action=deleteRequest&userId=${result.userId}" title="" class="add-butn more-action"
                                                                               data-ripple="">delete Request</a>
                                                                            <a href="/friends?action=confirmRequest&userId=${result.userId}" title="" class="add-butn"
                                                                               data-ripple="">Confirm</a>
                                                                        </c:when>
                                                                        <c:when test="${result.extraField1 == 'ToRequest'}">
                                                                            <a href="/friends?action=deleteRequest&userId=${result.userId}" title="" class="add-butn more-action"
                                                                               data-ripple="">delete Request</a>
                                                                        </c:when>
                                                                        <c:when test="${result.extraField1 == 'Not'}">
                                                                            <a href="/friends?action=sendRequest&userId=${result.userId}"
                                                                               title="" class="add-butn" data-ripple="">Add
                                                                                Friend</a>
                                                                        </c:when>
                                                                    </c:choose>
                                                                </div>
                                        ...
                                        <ul id="people-list" class="friendz-list">
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="c6b1afa8b2a3b4b5a9aaa2a3b486a1aba7afaae8a5a9ab">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                                <figure>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="82e0e3f0ece7f1c2e5efe3ebeeace1edef">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                                <figure>
                                            ...
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="147e75677b7a76547379757d783a777b79">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="640e05170b0a06240309050d084a070b09">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="deb4bfadb1b0bc9eb9b3bfb7b2f0bdb1b3">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="bbd1dac8d4d5d9fbdcd6dad2d795d8d4d6">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="friendz-meta">
                                                    ...
                                                    <i><a href="https://wpkixx.com/cdn-cgi/l/email-protection"
                                                          class="__cf_email__"
                                                          data-cfemail="ff9d9e8d919a8cbf98929e9693d19c9092">[email&#160;protected]</a></i>
                                                </div>
                                            </li>
                                        </ul>
                                        <div class="chat-box">
