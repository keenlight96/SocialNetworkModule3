                                ...
                                <div class="central-meta item">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            ...
                                            <div class="friend-name" style="width: 70%">
                                                            ...
                                                            <div class="friend-info">
                                                                ...
                                                                <div class="friend-name">
                                                                    ...
                                                                    <form action="/postDetail" method="get">
                                                                        <input name="postId" type="text" hidden="hidden"
                                                                               value="${bigPost.sharedPost.postId}">
                                                                        <button type="submit" style="background: #088dcd">To Post
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                                <div class="description">
                                                                ...
                                                                <c:if test="${bigPost.sharedPostPhoto != null}">
                                                                    <img src="${bigPost.sharedPostPhoto}" alt="">
                                                                </c:if>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <li>
                                                            ...
                                                            <c:when test="${bigPost.isLiked()}">
                                                                <form action="/like" method="get">
                                                                    <input hidden="hidden" name="postId" value="${bigPost.postId}">
                                                                    <input hidden="hidden" name="action" value="toDislike">
                                                                    <button type="submit" class="icon-button" data-toggle="tooltip"
                                                                            title="dislike">
                                                                        <span class="like" >
                                                                              <i class="ti-heart"></i>
                                                                </c:when>
                                                                ...
                                                                <form action="/like" method="get">
                                                                    <input hidden="hidden" name="postId" value="${bigPost.postId}">
                                                                    <input hidden="hidden" name="action" value="toLike">
                                                                <button type="submit" class="icon-button" data-toggle="tooltip"
                                                                        title="like">
                                                                        <span class="dislike" >
                                                            ...
                                                            <ins>${bigPost.getLikes().size()}</ins></span></button>
                                                                </form>
                                                        </li>
                                                        <li class="social-media">
                                                            <!-- Button trigger modal -->
                                                            <button type="button" class="fa fa-share-alt" style="border: none; outline: none; background-color: transparent;" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                            </button>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <form action="/share" method="post">
                                                                            <div class="modal-header">
                                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Share the post</h1>
                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <textarea rows="2" placeholder="write something"
                                                                                          name="post-content"></textarea>
                                                                                <input type="text" hidden="hidden" name="postSourceId" value="${bigPost.postId}">
                                                                            </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="we-comment">
                                                            <div class="coment-head">
                                                                <h5><a href="/time-line?userId=${comment.user.userId}" title="">
                                                    ...
                                                    <div class="post-comt-box">
                                                        <form action="/comment" method="post">
                                                            ...
                                                            <div class="add-smiles">
                                                                <button type="submit" style="background: #088dcd">Post</button>
                                                            </div>
