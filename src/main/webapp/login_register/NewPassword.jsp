    ...
    <div class="container">
        <div class="row justify-content-center mt-custom">
            <div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
                <!-- White Container -->
                <div class="container bg-dark text-white rounded mt-2 mb-2 px-0">
                    <!-- Main Heading -->
                    ...
                    <div class="pt-3 pb-3">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row justify-content-center">
                                <button type="submit" class="btn btn-outline-light w-50">Reset</button>
                            </div>
                        </form>
                    </div>
                    <!-- Alternative Login -->
                    <div class="mx-0 px-0 bg-dark">
                        <!-- Horizontal Line -->
                        <div>
                            <hr>
                        </div>
