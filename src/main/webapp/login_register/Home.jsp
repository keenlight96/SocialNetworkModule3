...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-2 bg-dark fixed-top" style="height: 100vh;border-right:1px solid seagreen;opacity: 0.5 ">
                ...
                <div class="row mt-2">
                  <div class="col-md-11">
                    <div class="form-outline">
                                                <textarea class="form-control" style="border: none;padding: 0;background-color: transparent;resize: none;outline: none" aria-label="Add a comment"
