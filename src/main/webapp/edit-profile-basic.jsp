									...
									<div class="widget stick-widget">
										...
										<ul class="naves">
											<li>
												...
												<a href="edit-profile-basic.jsp" title="">Basic info</a>
											</li>
											<li>
									...
									<div class="editing-info">
										...
										<form action="/user" method="post">
											...
											<div class="form-group half">
											  <input type="text" id="input" name="firstName" value="${user.firstName}" required="required"/>
											...
											<div class="form-radio">
											  <div class="radio">
												<label>
												  <input type="radio" checked="checked" value="${user.gender}" name="gender"><i class="check-box"></i>Male
												</label>
											  </div>
											  <div class="radio">
												<label>
												  <input type="radio" value="${user.gender}" name="gender"><i class="check-box"></i> Female
												</label>
											  </div>
											</div>
											<div class="form-group">	
